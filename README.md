...
React was chosen for this project to facilitate state management and to easily pass
the data around to different components to make interactivity and re-usability easier.
